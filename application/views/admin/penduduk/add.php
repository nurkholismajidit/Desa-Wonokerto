                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="dusun">
                            ...
                            <option value="Krajan Utara">Krajan Utara</option>
                            <option value="Krajan Selatan">Krajan Selatan</option>
                            <option value="Krajan Tengah">Krajan Tengah</option>
                            <option value="Krajan Timur Jurang">Krajan Timur Jurang</option>
                        </select>
