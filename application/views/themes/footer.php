        ...
        <div class="row">
            ...
            <div class="span4">
                <div class="widget">
                    ...
                    <address>
                        <strong>Kantor Desa Wonokerto</strong><br>
                        Jl. Sukorejo - Bangil , Wonokerto, Kecamatan Sukorejo,<br>
                        Kabupaten Pasuruan. Kode Pos 67161. Indonesia
                    </address>
                    <p>
                        <i class="icon-phone"></i> 0852-9262-6598 <br>
                        <i class="icon-envelope-alt"></i> wonokerto@gmail.com
                    </p>
                </div>
            </div>
            <div class="span4">
    ...
    <div id="sub-footer">
        <div class="container">
            <div class="row">
                <div class="span6">
                    <div class="copyright">
                        <p><span>&copy; Copyright <?= date('Y'); ?>. Desa Wonokerto</span></p>
                    </div>
                </div>
            </div>
        </div>
