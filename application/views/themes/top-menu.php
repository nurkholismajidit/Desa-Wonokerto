<header>
    <div class="top">
        <div class="container">
            <div class="row">
                <div class="span6">
                    <p class="topcontact"><i class="icon-google-plus"></i> desawonokerto@gmail.com</p>
                </div>
                <div class="span6">
    ...
    <div class="container">
        ...
        <div class="row nomargin">
            <div class="span4">
                <div class="logo">
                    <a href="<?= base_url(); ?>"><img src="<?php echo base_url('public/'); ?>img/WONOKERTO (1).png" alt="" /></a>
                </div>
            </div>
            <div class="span8">
                        ...
                        <nav>
                            <ul class="nav topnav">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown"><a href="#">Profil Desa<i class="icon-angle-right"></i></a>
                                            <ul class="dropdown-menu sub-menu-level1">
                                                ...
                                                <li><a href="<?php echo base_url('profil/sejarahdesa'); ?>">Sejarah Desa</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= base_url('lembagadesa/karangtaruna'); ?>">Karang Taruna</a></li>
                                        <li><a href="#">PKK</a></li>
                                ...
                                <li class="dropdown">
                                    <a href="#">Produk <i class="icon-angle-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= base_url('galeri/foto'); ?>">Link Shopee</a></li>
