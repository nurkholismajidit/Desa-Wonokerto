...
<script type="text/javascript">
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            labels: ['Petani', 'Buruh Tani', 'Buruh Swasta', 'PNS', 'Guru Swasta', 'Pedagang', 'Tukang Kayu/Batu', 'Peternak', 'Montir', 'Tenaga Medis', 'Biro Jasa Angkut', 'Pensiunan', 'ABRI', 'Pengrajin/Industri', 'Penjahit', 'Sopir'],
            datasets: [{
                label: 'Grafik Penduduk',
                data: ['945', '867', '91', '4', '24', '42', '139', '5', '11', '-', '-', '15', '3', '15', '24', '27'],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
